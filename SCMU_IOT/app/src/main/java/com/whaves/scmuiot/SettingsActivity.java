...
public class SettingsActivity extends Activity implements LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.whaves.scmuiot.R.layout.settings);
        ...
        editTextPosicoes = (EditText) findViewById(com.whaves.scmuiot.R.id.editTextPosicoes);
        ...
        scroller = (ScrollView) findViewById(com.whaves.scmuiot.R.id.scroller);
        ...
        toggleSMSbt = (ToggleButton) findViewById(com.whaves.scmuiot.R.id.toggleSMS);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(com.whaves.scmuiot.R.menu.menu_main, menu);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case com.whaves.scmuiot.R.id.action_settings:
                abreConfiguracaoDoDispositivo();
                break;
        }
